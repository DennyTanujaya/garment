<?php
	...
	if(!isset($_SESSION['nama_user'])){
		...
		if(isset($_GET['id_karyawan'])){
			...
			$query_mysql = mysqli_query($connect,"select * from salary_cmt WHERE id_karyawan='$id' AND tanggal_gajian='$tanggal_gajian'");
			$data = mysqli_fetch_array($query_mysql);
			$query_mysql_salary = mysqli_query($connect,"select * from salary_cmt WHERE id_karyawan='$id' AND tanggal_gajian='$tanggal_gajian'");
